...
class WindowsPanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.nameLb1 = wx.StaticText(self, -1, "Name:")
        self.nameLb1.SetFont(self.font)
        self.name = wx.TextCtrl(self, -1, "", size=(140, 22))
        self.name.SetFont(self.font2)
        self.nameLb2 = wx.StaticText(self, -1, "Address:")
        self.nameLb2.SetFont(self.font)
        self.address = wx.TextCtrl(self, -1, "", size=(80, 22))
        self.address.SetFont(self.font2)
        self.nameLb3 = wx.StaticText(self, -1, "H.Quarters:")
        self.nameLb3.SetFont(self.font)
        self.headq = wx.TextCtrl(self, -1, "")
        self.headq.SetFont(self.font2)
        self.nameLb4 = wx.StaticText(self, -1, "Branch:")
        self.nameLb4.SetFont(self.font)
        self.branch = wx.TextCtrl(self, -1, "")
        self.branch.SetFont(self.font2)
        self.nameLb5 = wx.StaticText(self, -1, "Town:")
        self.nameLb5.SetFont(self.font)
        self.town = wx.TextCtrl(self, -1, "")
        self.town.SetFont(self.font2)
        self.nameLb6 = wx.StaticText(self, -1, "Telephone")
        self.nameLb6.SetFont(self.font)
        self.telephone = wx.TextCtrl(self, -1, "")
        self.telephone.SetFont(self.font2)
        self.nameLb7 = wx.StaticText(self, -1, "Mobile:")
        self.nameLb7.SetFont(self.font)
        self.mobile = wx.TextCtrl(self, -1, "")
        self.mobile.SetFont(self.font2)
        self.nameLb8 = wx.StaticText(self, -1, "Fax:")
        self.nameLb8.SetFont(self.font)
        self.fax = wx.TextCtrl(self, -1, "")
        self.fax.SetFont(self.font2)
        self.nameLb9 = wx.StaticText(self, -1, "Website:")
        self.nameLb9.SetFont(self.font)
        self.website = wx.TextCtrl(self, -1, "")
        self.website.SetFont(self.font2)
        self.nameLb9l = wx.StaticText(self, -1, "E-mail:")
        self.nameLb9l.SetFont(self.font)
        self.email = wx.TextCtrl(self, -1, "")
        self.email.SetFont(self.font2)
        ...
        for i in range(0, 4):
            addrSizer.Add((0, 10))
        addrSizer.Add(self.nameLb1, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, border=7)
        addrSizer.Add(self.name, 0, wx.EXPAND)
        addrSizer.Add(self.nameLb2, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, border=7)
        addrSizer.Add(self.address, 0, wx.EXPAND)
        addrSizer.Add(self.nameLb3, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, border=7)
        addrSizer.Add(self.headq, 0, wx.EXPAND)
        addrSizer.Add(self.nameLb4, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, border=7)
        addrSizer.Add(self.branch, 0, wx.EXPAND)
        addrSizer.Add(self.nameLb5, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, border=7)
        addrSizer.Add(self.town, 0, wx.EXPAND)
        addrSizer.Add(self.nameLb6, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, border=7)
        addrSizer.Add(self.telephone, 0, wx.EXPAND)
        addrSizer.Add(self.nameLb7, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, border=7)
        addrSizer.Add(self.mobile, 0, wx.EXPAND)
        addrSizer.Add(self.nameLb8, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, border=7)
        addrSizer.Add(self.fax, 0, wx.EXPAND)
        addrSizer.Add(self.nameLb9, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, border=7)
        addrSizer.Add(self.website, 0, wx.EXPAND)
        addrSizer.Add(self.nameLb9l, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, border=7)
